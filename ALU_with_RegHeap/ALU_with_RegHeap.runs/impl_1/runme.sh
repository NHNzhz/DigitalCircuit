...
HD_PWD='D:/vivadoprog/ALU_with_RegHeap/ALU_with_RegHeap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_main.tcl -notrace
