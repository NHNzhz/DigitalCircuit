...
HD_PWD='D:/vivadoprog/ALU_with_RegHeap/ALU_with_RegHeap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_main.tcl
