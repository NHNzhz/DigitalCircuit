...
HD_PWD='D:/vivadoprog/digital_tube_scan/digital_tube_scan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tube_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tube_display.tcl -notrace
