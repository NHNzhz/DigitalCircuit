...
HD_PWD='D:/vivadoprog/digital_tube_scan/digital_tube_scan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tube_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tube_display.tcl
